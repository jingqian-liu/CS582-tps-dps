...
class Logger:
    ...
    def __call__(self, loss, tps_loss, kl_loss, recon_loss, rollout, policy):
        metrics = self.metrics()
        

        log_msg = f"Rollout {rollout}: Loss = {loss:.6f}, TPS Loss = {tps_loss:.6f}, KL Loss = {kl_loss:.6f}, Recons Loss = {recon_loss:.6f}, RMSD = {metrics['rmsd']:.6f}, Best RMSD = {self.rmsd:.6f}"
